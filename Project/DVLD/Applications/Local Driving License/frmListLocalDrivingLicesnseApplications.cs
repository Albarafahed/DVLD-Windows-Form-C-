...
namespace DVLD
{
    public partial class frmListLocalDrivingLicesnseApplications : Form
    {
        ...
        private void btnAddNewApplication_Click(object sender, EventArgs e)
        {
            ...
            this.frmListLocalDrivingLicesnseApplications_Load(null, null);
        }
        ...
        private void CancelApplicaitonToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            int LocalDrivingLicenss = (int)dgvLocalDrivingLicenseApplications.CurrentRow.Cells[0].Value;

            clsLocalDrivingApplication LocalDrivingLicenseApplication = clsLocalDrivingApplication.FindByLocalDrivingAppLicenseID(LocalDrivingLicenss);
        ...
        private void showPersonLicenseHistoryToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            int PersonID = clsLocalDrivingApplication.FindByLocalDrivingAppLicenseID((int)dgvLocalDrivingLicenseApplications.CurrentRow.Cells[0].Value).ApplicantPersonID;
