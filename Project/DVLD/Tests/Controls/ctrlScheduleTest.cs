...
namespace DVLD.Tests.Controls
{
    public partial class ctrlScheduleTest : UserControl
    {
        ...
        public void LoadInfo(int LocalDrivingLicenseApplicationID,int TestAppointmentID,clsTest.enStatues statues=clsTest.enStatues.NotFound)
        {
            ...
            if (_Statues == clsTest.enStatues.Fail)
