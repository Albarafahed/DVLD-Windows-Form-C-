...
namespace DVLD_Buisness
{
    public class clsLicense
    {
        ...
        public int Relase(int ReleasedByUserID)
        {
            ...
            if (this.DetainedInfo.Relase(ReleasedByUserID, Application.ApplicationID))
        ...
        public clsLicense ReplaceLostOrDamagedLicenseApplication(string Notes, int CreatedByUserID,clsApplication.enApplicationType AplicationType)
        {
            clsApplication Application = new clsApplication();
            ...
            Application.ApplicationStatus = clsApplication.enApplicationStatus.Completed;
            Application.LastStatusDate = DateTime.Now;
            if (AplicationType == clsApplication.enApplicationType.ReplaceLostDrivingLicense)
            {
                Application.ApplicationTypeID = (int)clsApplication.enApplicationType.ReplaceLostDrivingLicense;
                Application.PaidFees = clsApplicationType.Find((int)clsApplication.enApplicationType.ReplaceLostDrivingLicense).Fees;
            }
            else
            {
                Application.ApplicationTypeID = (int)clsApplication.enApplicationType.ReplaceDamagedDrivingLicense;
                Application.PaidFees = clsApplicationType.Find((int)clsApplication.enApplicationType.ReplaceDamagedDrivingLicense).Fees;
            }
